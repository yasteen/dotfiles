...
# Safety rm and mv alias
alias rm='rm -i'
alias mv='mv -i'

# FANCY BASH PROMPT
# if [ -f ~/.fancy_bash ]; then
#     . ~/.fancy_bash
# fi
...
# background image
# feh --bg-tile ~/Pictures/Resources/background.jpg

# Compton inactive dimming
# compton --config /home/justin/.config/compton.conf
